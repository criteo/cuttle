...
object HelloCronDagScheduling {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val cronJobP1 = Job(id = "job1", name = "Job 1", description = "This is job 1", scheduling = CronScheduling(1)) {
      implicit e =>
        Future {
    ...
    val cronJobP2 = Job(id = "job2", name = "Job 2", description = "This is job 2", scheduling = CronScheduling(2)) {
      implicit e =>
        Future {
          val value = rand.nextInt(100)
    ...
    val cronJobP3 = Job(id = "job3", name = "job 3", description = "This is job 3", scheduling = CronScheduling(3)) {
      implicit e =>
        Future {
    ...
    val cronJobP4 = Job(id = "job4", name = "job 4", description = "This is job 4", scheduling = CronScheduling(4)) {
      implicit e =>
        Future {
          val x = readIntFromFile(fileNamea1)
          val y = readIntFromFile(fileNamea2)
    ...
    val cronJobP5 = Job(id = "job5", name = "job 5", description = "This is job 5", scheduling = CronScheduling(5)) {
      implicit e =>
        Future {
    ...
    val cronJobP6 = Job(id = "job6", name = "Job 6", description = "This is job 6", scheduling = CronScheduling(6)) {
      implicit e =>
        Future {
    ...
    val cronJobP7 = Job(id = "job7", name = "job 7", description = "This is job 7", scheduling = CronScheduling(7)) {
      implicit e =>
        Future {
    ...
    val cronJobP8 = Job(id = "job8", name = "job 8", description = "This is job 8", scheduling = CronScheduling(8)) {
      implicit e =>
        Future {
