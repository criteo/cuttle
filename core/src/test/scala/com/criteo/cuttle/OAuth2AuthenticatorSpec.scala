...
import com.criteo.cuttle.SuiteUtils.testAppSecret
import com.criteo.cuttle.authentication.{JWT, OAuth2Authenticator, OAuth2ClientConfig}
import lol.http._
...
/**
  ...
  */
class OAuth2AuthenticatorSpec extends FunSuite with JWT  {
